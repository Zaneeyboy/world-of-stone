  ...
  return (
    <div className='max-w-7xl mx-auto px-6 py-8'>
      ...
      <div className='flex items-center justify-between mb-8'>
        <p className='text-foreground-muted text-sm'>Manage site-wide banners and promotional messages.</p>
        <button
          onClick={() => setFormOpen(true)}
          className='flex items-center gap-2 px-4 py-2 bg-gold text-background text-xs font-semibold uppercase tracking-wider hover:bg-gold-light transition-colors'
        >
